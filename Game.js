 ...
 window.addEventListener('load', () => {
  ...
  function startGame() {
    ...
    function buildChoiceElement(isItUserElement, className) {
        ...
        el.innerHTML = `<img src="https://raw.githubusercontent.com/CompetentProgramming/rock-paper-scissors-lizard-spock/c40e3e06639b4a9ec37c3459f336e7c7ad31c768/images/icon-${className}.svg" alt="${className}">`;
        if (isItUserElement) {
